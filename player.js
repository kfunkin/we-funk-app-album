...
let aPlayer = document.querySelector("#controls-container");
let ctrls = document.querySelector(".controlsOuter");
let playerStatus = false;

aBtn.addEventListener("click", function() {
    if(playerStatus === false) {
      aPlayer.style.height = "300px";
      aPlayer.style.opacity = "0.9";
...
var elms = ['track', 'timer', 'duration', 'playBtn', 'pauseBtn', 'prevBtn', 'nextBtn', 'playlistBtn', 'volumeBtn', 'progress', 'bar', 'loading', 'playlist', 'list', 'barEmpty', 'barFull'];
  ...
  play: function(index) {
    ...
    if (data.howl) {
      ...
      sound = data.howl = new Howl({
        src: ['./audio/' + data.file, './audio/' + data.file + '.mp3'],
